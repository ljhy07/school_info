...
class Cafeteria:
    ...
    def cafe(self):
        ...
        url = f"https://open.neis.go.kr/hub/mealServiceDietInfo?Type=json&pIndex=1&pSize=100&ATPT_OFCDC_SC_CODE={self.school_info.atpt_code}&SD_SCHUL_CODE={self.school_info.schul_code}&MLSV_YMD={yearTime.zfill(4)}{monthTime.zfill(2)}{dayTime.zfill(2)}"
